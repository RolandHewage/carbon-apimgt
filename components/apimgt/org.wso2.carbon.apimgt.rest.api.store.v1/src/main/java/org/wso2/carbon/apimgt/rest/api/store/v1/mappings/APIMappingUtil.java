...
public class APIMappingUtil {
    ...
    private static APIEndpointURLsDTO fromAPIRevisionToEndpoints(ApiTypeWrapper model, String organization,
        ...
        Map<String, String> hostsWithSchemes = apiEndpointUrlExtractor.
                getHostWithSchemeMappingForEnvironment(model, organization, environment.getName());
        List<EndpointUrl> endpointUrls = apiEndpointUrlExtractor.getApiEndpointUrls(model, hostsWithSchemes);
